...
public class BuildParameters
{
    ...
    public const string MainRepoName = "Cake.Transifex";
    ...
    public bool ShouldPublish
    {
        get
        {
            return !IsLocalBuild && !IsPullRequest && IsMainRepo && IsTagged;
        }
    }
    ...
    public bool ShouldCreateReleaseNotes
    {
        get
        {
            return IsPublishBuild || (!IsLocalBuild && !IsPublishBuild && IsMainRepo && IsMainBranch && !IsTagged);
        }
    }
    ...
    {
        return buildSystem.AppVeyor.Environment.Repository.Tag.IsTag && !string.IsNullOrWhiteSpace(buildSystem.AppVeyor.Environment.Repository.Tag.Name);
    }
